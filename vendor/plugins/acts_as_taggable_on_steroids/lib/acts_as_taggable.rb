    ...
    module Taggable #:nodoc:
      ...
      module ClassMethods
        def acts_as_taggable(options = {})
          has_many :taggings, :as => :taggable, :include => :tag, :dependent => :delete_all
      ...
      module InstanceMethods
        ...
        # PFZ added remove_old argument
        def write_tags_impl(list, remove_old=true)
          ...
          Tag.transaction do
            ...
            Tagging.delete_all(['id in (?)', old_tagging_ids]) if remove_old && old_tagging_ids.any?
        ...
        # PFZ
        def write_tags(list)
          write_tags_impl(list, true)
        end
        
        # PFZ
        def append_tags(list)
          write_tags_impl(list, false)
        end
